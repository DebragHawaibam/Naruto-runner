...
function preload(){
  mario_running = loadAnimation("naruto.png");
  mario_collided = loadAnimation("naruto_collided.png");
  groundImage = loadImage("background.jpg");
  collideSound = loadSound("end.mp3");
  coinsound = loadSound("coin.wav");
  
  coinImage = loadImage("star.png");
  obstacle2 = loadImage("kunai_.png");
  obstacle1 = loadImage("suriken.png");
  obstacle3 = loadImage("dragon_.png");
...
function setup() {
  ...
  ground = createSprite(100,190,1200,10);
...
function draw() {
  ...
  textSize(20);
  fill('#9353e3');
  text("Star collected: "+ score, 440,40);
  ...
  text("High-Sore : " + localStorage["HighestScore"], 440, 58);
}
